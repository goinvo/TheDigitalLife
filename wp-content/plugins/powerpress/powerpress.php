...
// Added by Reshma 
function powerpress_get_podcast_duration($postID) 
{
	$EpisodeData = powerpress_get_enclosure_data($postID, $feed_slug);
	return powerpress_readable_duration($EpisodeData['duration']);
}

function powerpress_get_podcast_downloadlink($postID) 
{
	$EpisodeData = powerpress_get_enclosure_data($postID, $feed_slug);
	$downloadLink = $EpisodeData['url'];
	return $downloadLink;
}
